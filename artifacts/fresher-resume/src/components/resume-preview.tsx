...
function T1MinimalATS({ data, resumeName, fontFamily }: TP) {
  ...
  return (
    <div className="resume-preview" style={{ fontFamily: ff, padding: "44px 52px", background: "#fff", color: "#111" }}>
      ...
      {data.experience.length > 0 && (<><h2 style={sh}>Work Experience</h2>{data.experience.map(e => (<div key={e.id} style={{ marginBottom: 10 }}><div style={{ display: "flex", justifyContent: "space-between" }}><span style={{ fontWeight: 600, fontSize: 12 }}>{e.position}, {e.company}</span><span style={{ fontSize: 11, color: "#555" }}>{e.startDate} – {e.isCurrent ? "Present" : e.endDate}</span></div><p style={{ fontSize: 11, color: "#444", margin: "3px 0 0", lineHeight: 1.6 }}>{e.responsibilities}</p></div>))}</>)}
    ...
    <div className="resume-preview" style={{ fontFamily: ff, background: "#fff", color: "#222", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ display: "flex", flex: 1 }}>
        ...
        <div style={{ flex: 1, padding: "20px 28px" }}>
          ...
          {data.experience.length > 0 && (<><div style={mainTitle}>Work Experience</div>{data.experience.map(e => (<div key={e.id} style={{ marginBottom: 14 }}><div style={{ display: "flex", justifyContent: "space-between" }}><span style={{ fontWeight: 700, fontSize: 13, color: navy }}>{e.position}</span><span style={{ fontSize: 10, color: "#777", fontStyle: "italic" }}>{e.startDate} – {e.isCurrent ? "Present" : e.endDate}</span></div><div style={{ fontSize: 11, color: "#555", marginBottom: 3 }}>{e.company}</div><p style={{ fontSize: 11, color: "#444", margin: 0, lineHeight: 1.6 }}>{e.responsibilities}</p></div>))}</>)}
    ...
    <div className="resume-preview" style={{ fontFamily: ff, display: "flex", background: "#fff", color: "#222" }}>
      ...
      <div style={{ flex: 1, padding: "32px 28px" }}>
        ...
        {["experience", "projects", "education", "certifications"].map(section => {
          if (section === "experience" && data.experience.length > 0) return (<div key="exp" style={{ marginBottom: 20 }}><div style={{ fontSize: 9, fontWeight: 700, letterSpacing: 2, textTransform: "uppercase" as const, color: "#7C3AED", marginBottom: 10, display: "flex", alignItems: "center", gap: 8 }}><div style={{ height: 2, width: 20, background: "#7C3AED" }} />Experience</div>{data.experience.map(e => (<div key={e.id} style={{ marginBottom: 12, paddingLeft: 14, borderLeft: "3px solid #e9d5ff" }}><div style={{ fontWeight: 700, fontSize: 13, color: "#1f2937" }}>{e.position}</div><div style={{ fontSize: 11, color: "#7C3AED", fontWeight: 500, marginBottom: 2 }}>{e.company} · <span style={{ color: "#9ca3af" }}>{e.startDate} – {e.isCurrent ? "Present" : e.endDate}</span></div><p style={{ fontSize: 11, color: "#4b5563", margin: 0, lineHeight: 1.6 }}>{e.responsibilities}</p></div>))}</div>);
  ...
  return (
    <div className="resume-preview" style={{ fontFamily: ff, background: "#fff", color: "#222" }}>
      ...
      <div style={{ padding: "8px 48px 36px" }}>
        ...
        {data.experience.length > 0 && (<><div style={sh}><div style={{ flex: 1, height: 1, background: "#e5e7eb" }} />Professional Experience<div style={{ flex: 1, height: 1, background: "#e5e7eb" }} /></div>{data.experience.map((e, i) => (<div key={e.id} style={{ display: "flex", gap: 20, marginBottom: 18 }}><div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 0, paddingTop: 4 }}><div style={{ width: 12, height: 12, borderRadius: "50%", background: gold, flexShrink: 0 }} />{i < data.experience.length - 1 && <div style={{ width: 1, flex: 1, background: "#e5e7eb", marginTop: 4 }} />}</div><div style={{ flex: 1 }}><div style={{ display: "flex", justifyContent: "space-between" }}><div style={{ fontWeight: 700, fontSize: 14, color: charcoal }}>{e.position}</div><span style={{ fontSize: 11, color: "#6b7280", fontStyle: "italic" }}>{e.startDate} – {e.isCurrent ? "Present" : e.endDate}</span></div><div style={{ fontSize: 12, color: gold, fontWeight: 600, marginBottom: 4 }}>{e.company}</div><p style={{ fontSize: 12, color: "#4b5563", margin: 0, lineHeight: 1.7 }}>{e.responsibilities}</p></div></div>))}</>)}
    ...
    <div className="resume-preview" style={{ fontFamily: ff, background: "#fff", color: "#24292f" }}>
      ...
      <div style={{ display: "flex", flex: 1 }}>
        ...
        <div style={{ flex: 1, padding: "24px 28px" }}>
          ...
          {data.experience.length > 0 && (<><div style={{ fontSize: 11, fontWeight: 700, color: green, marginBottom: 10 }}>{"// Experience"}</div>{data.experience.map(e => (<div key={e.id} style={{ marginBottom: 14, padding: "12px 14px", border: `1px solid ${darkBorder}`, borderRadius: 6 }}><div style={{ display: "flex", justifyContent: "space-between", marginBottom: 2 }}><div style={{ fontWeight: 700, fontSize: 13, fontFamily: "sans-serif" }}>{e.position}</div><span style={{ fontSize: 10, color: "#6b7280", fontFamily: "sans-serif" }}>{e.startDate} – {e.isCurrent ? "Present" : e.endDate}</span></div><div style={{ fontSize: 11, color: green, marginBottom: 4, fontFamily: "sans-serif" }}>{e.company}</div><p style={{ fontSize: 11, color: "#4b5563", margin: 0, lineHeight: 1.6, fontFamily: "sans-serif" }}>{e.responsibilities}</p></div>))}</>)}
  ...
  return (
    <div className="resume-preview" style={{ fontFamily: ff, background: bg, color: "#e2e8f0", display: "flex" }}>
      ...
      <div style={{ flex: 1, padding: "30px 28px" }}>
        ...
        {data.experience.length > 0 && (<div style={{ marginBottom: 18 }}><div style={{ fontSize: 9, fontWeight: 700, letterSpacing: 2, textTransform: "uppercase" as const, color: teal, marginBottom: 12 }}>Experience</div>{data.experience.map(e => (<div key={e.id} style={{ background: card, border: `1px solid #334155`, borderRadius: 8, padding: "12px 14px", marginBottom: 8 }}><div style={{ display: "flex", justifyContent: "space-between" }}><span style={{ fontWeight: 700, fontSize: 13, color: "#f1f5f9" }}>{e.position}</span><span style={{ fontSize: 10, color: muted }}>{e.startDate}–{e.isCurrent ? "Now" : e.endDate}</span></div><div style={{ fontSize: 11, color: teal, fontWeight: 500, marginBottom: 4 }}>{e.company}</div><p style={{ fontSize: 11, color: "#94a3b8", margin: 0, lineHeight: 1.6 }}>{e.responsibilities}</p></div>))}</div>)}
    ...
    <div className="resume-preview" style={{ fontFamily: ff, background: "#fff", color: "#1f2937" }}>
      ...
      <div style={{ display: "flex", gap: 0 }}>
        ...
        <div style={{ flex: 1, padding: "24px 28px" }}>
          ...
          {data.experience.length > 0 && (<div style={{ marginBottom: 20 }}><div style={{ fontSize: 9, fontWeight: 700, letterSpacing: 2, textTransform: "uppercase" as const, color: indigo, marginBottom: 12, display: "flex", alignItems: "center", gap: 8 }}><div style={{ width: 6, height: 6, borderRadius: "50%", background: indigo }} />Timeline · Experience</div>{data.experience.map((e, i) => (<div key={e.id} style={{ display: "flex", gap: 0, marginBottom: 0 }}><div style={{ display: "flex", flexDirection: "column", alignItems: "center", width: 24, marginRight: 12 }}><div style={{ width: 14, height: 14, borderRadius: "50%", background: i === 0 ? indigo : "#e5e7eb", border: `2px solid ${indigo}`, flexShrink: 0 }} />{i < data.experience.length - 1 && <div style={{ width: 2, flex: 1, background: `${indigo}30`, margin: "2px 0" }} />}</div><div style={{ flex: 1, paddingBottom: 14 }}><div style={{ display: "flex", justifyContent: "space-between" }}><span style={{ fontWeight: 700, fontSize: 13 }}>{e.position}</span><span style={{ fontSize: 10, color: "#9ca3af" }}>{e.startDate}–{e.isCurrent ? "Now" : e.endDate}</span></div><div style={{ fontSize: 11, color: indigo, fontWeight: 500, marginBottom: 3 }}>{e.company}</div><p style={{ fontSize: 11, color: "#4b5563", margin: 0, lineHeight: 1.6 }}>{e.responsibilities}</p></div></div>))}</div>)}
  ...
  return (
    <div className="resume-preview" style={{ fontFamily: ff, background: cream, color: brown }}>
      ...
      <div style={{ padding: "0 52px 40px" }}>
        ...
        {data.experience.length > 0 && (<><Ornament /><div style={{ fontSize: 10, letterSpacing: 4, textTransform: "uppercase" as const, color: warmGold, textAlign: "center", marginBottom: 14 }}>Professional Experience</div>{data.experience.map(e => (<div key={e.id} style={{ marginBottom: 16 }}><div style={{ display: "flex", justifyContent: "space-between" }}><div style={{ fontWeight: 700, fontSize: 14 }}>{e.position}</div><div style={{ fontSize: 11, color: warmGold, fontStyle: "italic" }}>{e.startDate} – {e.isCurrent ? "Present" : e.endDate}</div></div><div style={{ fontSize: 12, color: "#7c5c3e", fontStyle: "italic", marginBottom: 4 }}>{e.company}</div><p style={{ fontSize: 12, color: "#5c3d1e", lineHeight: 1.8, margin: 0, textAlign: "justify" }}>{e.responsibilities}</p></div>))}</>)}
